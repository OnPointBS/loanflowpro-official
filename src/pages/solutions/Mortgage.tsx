...
const Mortgage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Mortgage Lending Solutions | LoanFlowPro</title>
        <meta name="description" content="Streamline mortgage lending operations with our comprehensive loan management platform. Perfect for mortgage banks, credit unions, and mortgage lenders." />
        <meta name="keywords" content="mortgage lending, home loans, mortgage processing, mortgage software, mortgage management, residential lending" />
        <link rel="canonical" href="https://loanflowpro.com/solutions/mortgage" />
        
        {/* Open Graph */}
        <meta property="og:title" content="Mortgage Lending Solutions | LoanFlowPro" />
        <meta property="og:description" content="Streamline mortgage lending operations with our comprehensive loan management platform." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://loanflowpro.com/solutions/mortgage" />
        
        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Mortgage Lending Solutions | LoanFlowPro" />
        <meta name="twitter:description" content="Streamline mortgage lending operations with our comprehensive loan management platform." />
        ...
        {JSON.stringify({
          ...
          "description": "Streamline mortgage lending operations with our comprehensive loan management platform",
          "url": "https://loanflowpro.com/solutions/mortgage",
          "mainEntity": {
            "@type": "SoftwareApplication",
            "name": "LoanFlowPro Mortgage Lending",
      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-slate-300 mb-8 max-w-3xl mx-auto">
                Streamline mortgage lending operations with our comprehensive platform designed for mortgage banks, credit unions, and mortgage lenders.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Everything you need to efficiently manage mortgage loans, from application to closing
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg border border-slate-200 hover:shadow-xl transition-all duration-500 hover:-translate-y-2">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Loan Origination</h3>
                <p className="text-slate-600">
                  Streamlined mortgage application process with automated document collection and verification.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg border border-slate-200 hover:shadow-xl transition-all duration-500 hover:-translate-y-2">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Underwriting</h3>
                <p className="text-slate-600">
                  Advanced underwriting automation with risk assessment and compliance checking.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg border border-slate-200 hover:shadow-xl transition-all duration-500 hover:-translate-y-2">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Processing</h3>
                <p className="text-slate-600">
                  Comprehensive mortgage processing with workflow automation and status tracking.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg border border-slate-200 hover:shadow-xl transition-all duration-500 hover:-translate-y-2">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Closing</h3>
                <p className="text-slate-600">
                  Streamlined closing process with document preparation and e-signature integration.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg border border-slate-200 hover:shadow-xl transition-all duration-500 hover:-translate-y-2">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Servicing</h3>
                <p className="text-slate-600">
                  Complete mortgage servicing with payment processing and escrow management.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg border border-slate-200 hover:shadow-xl transition-all duration-500 hover:-translate-y-2">
                ...
                <h3 className="text-xl font-semibold text-slate-900 mb-4">Compliance</h3>
                <p className="text-slate-600">
                  Built-in compliance for TRID, RESPA, HMDA, and other mortgage regulations.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-slate-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-slate-900 mb-4">
                Why Choose LoanFlowPro for Mortgage Lending?
              </h2>
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Our platform is specifically designed to address the unique challenges of mortgage lending
              </p>
            </div>
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span className="text-slate-700">Reduce processing time by up to 50%</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-[#D4AF37] mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span className="text-slate-700">Advanced risk assessment tools</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-[#D4AF37] mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
        ...
        <section className="py-20 bg-slate-900 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <h2 className="text-4xl font-bold text-white mb-6">
              Ready to Transform Your Mortgage Lending?
            </h2>
            <p className="text-xl text-slate-300 mb-8">
              Join leading mortgage banks and credit unions who trust LoanFlowPro to streamline their mortgage lending operations.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/contact"
